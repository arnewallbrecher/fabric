...
type
  TForm71 = class(TForm)
    ...
    ButtonFotoweg: TButton;
    PanelSpeichern: TPanel;
    ListBoxSpeichern: TListBox;
    ButtonSpeichernweg: TButton;
    ...
    procedure ButtonFotowegClick(Sender: TObject);
    procedure ButtonSpeichernwegClick(Sender: TObject);
end;
...
begin
  ...
  ButtonFotoweg.Caption      := Tx(1682);
  ButtonSpeichernweg.Caption := Tx(1682);
  ImageFoto.Width         := 630;
...
procedure TForm71.ButtonFotowegClick(Sender: TObject);
begin
  PanelFoto.Visible := false;
end;
...
procedure TForm71.ButtonSpeichernwegClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
