...
procedure TForm31.ausZwischenablageClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
...
procedure TForm31.ausDateiClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
  SpeedZoom.Enabled           := true;
  Drueck.Enabled              := true;
...
procedure TForm31.SpeedLoadClick(Sender: TObject);
begin
  ausDateiClick(Sender);
end;

procedure TForm31.ZoomClick(Sender: TObject);
begin
...
procedure TForm31.SpeedZoomClick(Sender: TObject);
begin
  ZoomClick(Sender);
end;

procedure TForm31.DrueckClick(Sender: TObject);
begin
  Zoom.Enabled                := false;
  SpeedZoom.Enabled           := false;
...
procedure TForm31.SpeedRueckClick(Sender: TObject);
begin
  DrueckClick(Sender);
end;

procedure TForm31.ButtonSabbrechenClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
...
procedure TForm31.ButtonLabbrechenClick(Sender: TObject);
begin
  PanelLoad.Visible := false;
end;
...
procedure TForm31.ButtonPlotEndeClick(Sender: TObject);
begin
  GroupBoxPlotten.Visible := false;
end;
...
procedure TForm31.TextschreibenClick(Sender: TObject);
begin
...
procedure TForm31.SpeedTextClick(Sender: TObject);
begin
  TextschreibenClick(Sender);
end;

procedure TForm31.MaskEditTextKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm31.Image1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if BText then
  begin
...
procedure TForm31.TrueckClick(Sender: TObject);
begin
