...
//  LabelAutor.Caption            := Tx(74);
  ...
  LabelEinstellung.Caption      := Tx(1596);
  LabelOption.Caption           := '';
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\36Lagenkugel.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\36Nets.htm');
  end;
  HelpRouter1.free;
end;
