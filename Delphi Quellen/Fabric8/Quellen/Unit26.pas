...
begin
  ...
  Form26.Caption             := Tx(602);   {Fabric7: Paläo-Spannungen..}
  ...
  LabelPalaeo.Caption        := Tx(605);  {eines Paläo-Spannungsellipsoides}
  LabelHarnisch.Caption      := Tx(1565);  {mit der dieder-Methode}
...
begin
  ...
  and Gedrueckt[4] then
    Buttonweiter.Enabled := true;   {Button1 = weiter}
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\26Palaeospannung.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\26PaleoStress.htm');
  end;
  HelpRouter1.free;
end;
