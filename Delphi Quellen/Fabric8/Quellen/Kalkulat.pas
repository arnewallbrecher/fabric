...
procedure Rotieren(Aa,B,C:array of extended;Fs:byte;A:word;F:shortint;
                   Z:byte;Ad,Fd:extended;var Roa:word;var Rof,Sign:shortint);
...
procedure Algorithmus(Geftyp:byte ;Zahl:word;var La,Lp:integer;
                      ...
                      Fp:array of word);
procedure AlgorithmusT(Ap: array of word; Fp: array of shortint; Zahl: word);
...
procedure Bott (Anzahl:word; var Ahar, Astr, Fhar: array of word;
                var Fstr: array of shortint; Rfaktor:real; var Theta:integer);
...
begin
  ...
  repeat
    ...
    if Ma <= It then
    begin
      showmessage(Tx(446)+' '+IntToStr(MA)+' '+Tx(447)); {Kein Ergebnis nach .. Iterationen}
      goto Aus8;
    end;
    It := It + 1;
    Am := -Q[i,j];
