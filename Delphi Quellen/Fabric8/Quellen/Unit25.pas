...
begin
  ...
  begin
    ...
    begin
      ZeileDS := '  '+ RightS('000'+IntToStr(AziFeld[i]),3)
                +'/'+RightS('00'+IntToStr(FalFeld[i]),2);
      ListBoxDaten.Items.Add (ZeileDS);
    end;
...
procedure TForm25.ausZwischenablageClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
...
procedure TForm25.ausDateiClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
  SpeedZoom.Enabled           := true;
  Drueck.Enabled              := true;
...
procedure TForm25.ZoomClick(Sender: TObject);
begin
...
procedure TForm25.SpeedZoomClick(Sender: TObject);
begin
  ZoomClick(Sender);
end;

procedure TForm25.DrueckClick(Sender: TObject);
begin
  Zoom.Enabled                := false;
  SpeedZoom.Enabled           := false;
...
procedure TForm25.SpeedRueckClick(Sender: TObject);
begin
  DrueckClick(Sender);
end;

procedure TForm25.ButtonSausClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
...
procedure TForm25.ButtonLausClick(Sender: TObject);
begin
  PanelLoad.Visible := false;
end;
...
procedure TForm25.ButtonPlotEndeClick(Sender: TObject);
begin
  GroupBoxPlotten.Visible := false;
  PanelDaten.Visible      := true;
end;
...
procedure TForm25.TextschreibenClick(Sender: TObject);
begin
...
procedure TForm25.SpeedTextClick(Sender: TObject);
begin
  TextschreibenClick(Sender);
end;

procedure TForm25.MaskEditTextKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm25.TrueckClick(Sender: TObject);
begin
...
procedure TForm25.SpeedUnTextClick(Sender: TObject);
begin
  TrueckClick(Sender);
end;
