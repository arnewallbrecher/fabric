...
procedure TForm74.MaskEditLaengeChange(Sender: TObject);
var
  Datei : TextFile;
  i     : word;
begin
...
procedure TForm74.MaskEditLinksChange(Sender: TObject);
var
  Datei : TextFile;
  i     : word;
begin
...
procedure TForm74.MaskEditObenChange(Sender: TObject);
var
  Datei : TextFile;
  i     : word;
begin
...
procedure TForm74.MaskEditUnterschriftKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm74.RadioButtonlinksClick(Sender: TObject);
begin
  BuendigS := 'Links';
  Gedrueckt[3] := true;
  if (Gedrueckt[1] = true) and (Gedrueckt[2] = true)
...
procedure TForm74.RadioButtonzentriertClick(Sender: TObject);
begin
  BuendigS := 'Zentriert';
  Gedrueckt[3] := true;
  if (Gedrueckt[1] = true) and (Gedrueckt[2] = true)
...
procedure TForm74.RadioButtonrechtsClick(Sender: TObject);
begin
  BuendigS := 'Rechts';
  Gedrueckt[3] := true;
  if (Gedrueckt[1] = true) and (Gedrueckt[2] = true)
...
begin
  ...
  Hoehe   := round(PLaenge*ImageFoto.Height/ImageFoto.Width);;
  with Fenster do
  begin
    Left   := LRand;
    Top    := ORand;
...
procedure TForm74.ButtonAbbrechenClick(Sender: TObject);
begin
  PanelDrucken.Visible    := false;
  GroupBoxDrucken.Visible := false;
end;
