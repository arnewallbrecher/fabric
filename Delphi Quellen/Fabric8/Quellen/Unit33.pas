...
type
  TForm33 = class(TForm)
    ...
    SpeedWiederherstellen: TSpeedButton;
...
begin
  ...
  SpeedWiederherstellen.Hint       := Hilf(747);
  HolPixS                          := '';
  ...
  Wiederherstellen.Enabled      := false;
  SpeedWiederherstellen.Enabled := false;
end;
...
begin
  ...
  GroupBoxSpannungen.Visible := false;
  neinClick(Sender);
  Wiederherstellen.Enabled      := true;
  SpeedWiederherstellen.Enabled := true;
end;
...
procedure TForm33.ausZwischenablageClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
  SpeedZoom.Enabled           := true;
  Zwischen                    := true;
...
procedure TForm33.ButtonSabbrechenClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
...
procedure TForm33.ausDateiClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
  SpeedZoom.Enabled           := true;
  Drueck.Enabled              := true;
...
procedure TForm33.SpeedausDateiClick(Sender: TObject);
begin
  ausDateiClick(Sender);
end;

procedure TForm33.ZoomClick(Sender: TObject);
begin
...
procedure TForm33.SpeedZoomClick(Sender: TObject);
begin
  ZoomClick(Sender);
end;

procedure TForm33.DrueckClick(Sender: TObject);
begin
  Zoom.Enabled                := false;
...
procedure TForm33.SpeedRueckClick(Sender: TObject);
begin
  DrueckClick(Sender);
end;

procedure TForm33.ButtonLabbrechenClick(Sender: TObject);
begin
  PanelLoad.Visible := false;
end;
...
procedure TForm33.ButtonPlotEndeClick(Sender: TObject);
begin
  GroupBoxPlotten.Visible := false;
  PanelDaten.Visible      := true;
end;
...
procedure TForm33.TextschreibenClick(Sender: TObject);
begin
...
procedure TForm33.SpeedTextClick(Sender: TObject);
begin
  TextschreibenClick(Sender);
end;

procedure TForm33.MaskEditTextKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm33.Image1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if BText then
  begin
...
procedure TForm33.TrueckClick(Sender: TObject);
begin
...
procedure TForm33.SpeedUnTextClick(Sender: TObject);
begin
  TrueckClick(Sender);
end;
