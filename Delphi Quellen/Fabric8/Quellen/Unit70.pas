...
begin
  if EingabeS = 'aus Bild' then Form71.Show;
  if EingabeS = 'ausPolygon' then Form72.Show;
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\70Panozzo.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\70Panozzo.htm');
  end;
  HelpRouter1.free;
end;
