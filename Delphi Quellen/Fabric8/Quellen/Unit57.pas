...
type
  TForm57 = class(TForm)
    ...
    procedure ButtonOabbrechenClick(Sender: TObject);
...
begin
  ...
  ButtonOabbrechen.Caption   := Tx(1682);
...
procedure TForm57.ButtonOabbrechenClick(Sender: TObject);
begin
  PanelOeffnen.Visible := false;
end;
...
procedure TForm57.ButtonSabbrechenClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
...
procedure TForm57.TextschreibenClick(Sender: TObject);
begin
...
procedure TForm57.SpeedTextClick(Sender: TObject);
begin
  TextschreibenClick(Sender);
end;

procedure TForm57.MaskEditTextKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm57.Image1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if BText then
  begin
...
procedure TForm57.TrueckClick(Sender: TObject);
begin
  ...
  if texti = 0 then Trueck.Enabled := false;
end;

procedure TForm57.SpeedUnTextClick(Sender: TObject);
begin
  TrueckClick(Sender);
end;
