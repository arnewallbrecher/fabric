...
procedure TForm19.ausZwischenablageClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
...
procedure TForm19.ausDateiClick(Sender: TObject);
begin
  Zoom.Enabled                := true;
  SpeedZoom.Enabled           := true;
  Drueck.Enabled              := true;
...
procedure TForm19.ZoomClick(Sender: TObject);
begin
...
procedure TForm19.SpeedZoomClick(Sender: TObject);
begin
  ZoomClick(Sender);
end;

procedure TForm19.DrueckClick(Sender: TObject);
begin
  AusDatei.enabled            := true;
  SpeedHolen.Enabled          := true;
  if not ClipBoard.HasFormat(CF_Bitmap) then
  begin
    ausZwischenablage.Enabled   := false;
    SpeedZwischenablage.Enabled := false;
...
procedure TForm19.SpeedRueckClick(Sender: TObject);
begin
  DrueckClick(Sender);
end;

procedure TForm19.ButtonSabbrechenClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
...
procedure TForm19.ButtonLabbrechenClick(Sender: TObject);
begin
  PanelLoad.Visible := false;
end;
...
procedure TForm19.ButtonPlotEndeClick(Sender: TObject);
begin
  GroupBoxPlotten.Visible := false;
  PanelDaten.Visible      := true;
end;
...
procedure TForm19.MaskEditLaengeChange(Sender: TObject);
var
  Datei : TextFile;
  i     : word;
begin
...
procedure TForm19.MaskEditLinksChange(Sender: TObject);
var
  Datei : TextFile;
  i     : word;
begin
...
procedure TForm19.MaskEditObenChange(Sender: TObject);
var
  Datei : TextFile;
  i     : word;
begin
...
begin
  ...
  PLaenge  := StrToInt(MaskEditLaenge.Text);
  PLaenge := round(PLaenge*Printer.Pagewidth/100);
...
procedure TForm19.TextSchreibenClick(Sender: TObject);
begin
...
procedure TForm19.SpeedTextClick(Sender: TObject);
begin
  TextschreibenClick(Sender);
end;

procedure TForm19.MaskEditTextKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm19.Image1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if BText then
  begin
...
procedure TForm19.TrueckClick(Sender: TObject);
begin
...
procedure TForm19.SpeedUnTextClick(Sender: TObject);
begin
  TrueckClick(Sender);
end;
