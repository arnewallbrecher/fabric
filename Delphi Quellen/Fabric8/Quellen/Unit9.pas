...
begin
  ...
  begin
    ...
    UTischAchsen1.Visible := false;
    SpeedLineare.Visible  := false;
    SpeedUTischA.Visible  := false;
  end;
...
begin
  ...
  if Programm = 3 then SpeedUTischA.Enabled  := true;
  if Programm = 4 then SpeedLineare.Enabled := false;
  if Programm = 4 then SpeedUtischP.Enabled  := true;
...
begin
  ...
  begin
    ...
    if Programm = 3 then HelpRouter1.HelpJump(DateiS,'html\Deutsch\9PlotPunkte.htm');
    if Programm = 4 then HelpRouter1.HelpJump(DateiS,'html\Deutsch\9PlotGross.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    if Programm = 3 then HelpRouter1.HelpJump(DateiS,'html\English\9PlotPoints.htm');
    if Programm = 4 then HelpRouter1.HelpJump(DateiS,'html\English\9PlotGreat.htm');
  end;
  HelpRouter1.free;
end;
