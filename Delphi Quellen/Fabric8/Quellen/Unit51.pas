...
procedure TForm51.ButtonSabbrechenClick(Sender: TObject);
begin
  PanelSpeichern.Visible := false;
end;
...
begin
  ...
  begin
    ...
    XS := Inttostr(round((Xnull+Kante/20)*400));
    YS := IntToStr(round((Ynull+2*Kante/3)*400));
    WS := FloatToStr(Kante/50);
...
procedure TForm51.TextschreibenClick(Sender: TObject);
begin
...
procedure TForm51.SpeedTextClick(Sender: TObject);
begin
  TextschreibenClick(Sender);
end;

procedure TForm51.MaskEditTextKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = chr(13) then
  begin
...
procedure TForm51.Image1MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  if BText then
  begin
...
procedure TForm51.TrueckClick(Sender: TObject);
begin
...
procedure TForm51.SpeedUnTextClick(Sender: TObject);
begin
  TrueckClick(Sender);
end;
...
procedure TForm51.ButtonPlotEndeClick(Sender: TObject);
begin
  GroupBoxPlotten.Visible := false;
end;
