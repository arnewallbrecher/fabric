...
procedure TForm32.ButtonZuruckClick(Sender: TObject);
begin
 Form32.Close;
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\32Hoeppener.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\32Hoeppener.htm');
  end;
  HelpRouter1.free;
end;
