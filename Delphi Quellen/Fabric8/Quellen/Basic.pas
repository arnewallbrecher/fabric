...
const
  ...
  CSIDL_PROGRAMS = $2; // Startmenü: Programme
  ...
  CSIDL_COMMON_STARTMENU = $16; // "All Users" - Startmenü
  ...
  CSIDL_INTERNET_CACHE = $20; // IE: Temporäre Internetdateien
  ...
  CSIDL_ADMINTOOLS = $30; // Startmenü\Programme\Verwaltung
var
  pMalloc: IMalloc;
  pidl: PItemIDList;
  Path: PChar;
