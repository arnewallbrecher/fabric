object Form61: TForm61
  ...
  object PanelStreichen: TPanel
    Left = 32
    Top = 88
    Width = 441
    Height = 129
    TabOrder = 14
    object LabelStreichen: TLabel
      Left = 24
      Top = 16
      Width = 388
      Height = 23
      Caption = 'Dateneingabe: Streichen - Fallen - Fallrichtung'
      Font.Charset = ANSI_CHARSET
      Font.Color = clRed
      Font.Height = -21
      Font.Name = 'Times New Roman'
    ...
    object LabelKompr: TLabel
      ...
      Width = 265
      Height = 23
      Caption = 'Kompression: negatives Azimut'
      Font.Charset = ANSI_CHARSET
      Font.Color = clRed
      Font.Height = -21
      Font.Name = 'Times New Roman'
  ...
  object PanelBrunton: TPanel
    ...
    object MaskEditBEingabe: TMaskEdit
      Left = 168
      Top = 24
      Width = 65
      Height = 39
      ...
      TabOrder = 0
      Text = '___'
      OnKeyPress = MaskEditBEingabeKeyPress
    end
