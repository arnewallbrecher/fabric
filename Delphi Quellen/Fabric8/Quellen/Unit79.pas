...
var
  Form79    : TForm79;
  EingabeS  : string;
  Gedrueckt : array [0..6] of boolean;
  SektorS   : string;
...
begin
  ...
  if Gedrueckt[1] and Gedrueckt[2] and Gedrueckt[3]
    and Gedrueckt[4] and Gedrueckt[5] and Gedrueckt[6]
...
procedure TForm79.LineareClick(Sender: TObject);
begin
  Gefuegetyp           := 1;
  Gedrueckt[6]         := true;
  if Gedrueckt[1] and Gedrueckt[2] and Gedrueckt[3]
...
procedure TForm79.SpeedLineareClick(Sender: TObject);
begin
  LineareClick(Sender);
end;

procedure TForm79.FlaechenClick(Sender: TObject);
begin
  Gefuegetyp           := 2;
  Gedrueckt[6]         := true;
  if Gedrueckt[1] and Gedrueckt[2] and Gedrueckt[3]
...
procedure TForm79.SpeedFlaechenClick(Sender: TObject);
begin
