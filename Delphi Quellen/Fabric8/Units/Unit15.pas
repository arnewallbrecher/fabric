...
begin
  ...
  begin
    if BereichS = '1..180°' then ExtenS := 'STR';
    if BereichS = '1..360°' then ExtenS := 'AZI';
  end;
  if RichtungenS = 'Betraege' then
  begin
    if BereichS = '1..180°' then ExtenS := 'LST';
    if BereichS = '1..360°' then ExtenS := 'LAZ';
  end;
...
begin
  ...
  begin
    ...
    if Programm = 6 then HelpRouter1.HelpJump(DateiS,'html\Deutsch\15Zirkular.htm');
    if Programm = 7 then HelpRouter1.HelpJump(DateiS,'html\Deutsch\15Rose.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    if Programm = 6 then HelpRouter1.HelpJump(DateiS,'html\English\15Circular.htm');
    if Programm = 7 then HelpRouter1.HelpJump(DateiS,'html\English\15Rose.htm');
  end;
  HelpRouter1.free;
end;
