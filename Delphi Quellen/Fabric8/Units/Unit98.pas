...
begin
  ...
  RatioFl   := ImageFlinn.Width/ImageFlinn.Height;
  RatioHs   := ImageHsu.Width/ImageHsu.Height;
  ...
  ListBoxFlinn.Visible := false;
  for i := 1 to 7 do
    ListBoxHsu.Items.Add (Tx(1611+i));
  ListBoxHsu.Visible := false;     
end;
