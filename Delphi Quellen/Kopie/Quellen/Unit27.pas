...
procedure TForm27.DisketteB1Click(Sender: TObject);
begin
  Diskette(Laufw2S);
  if not Abbrechen then
    Stressein(Laufw2S, Anzahl, AziFeld, SAziFeld, FalFeld,
              SFalFeld);
end;
...
begin
  ...
  if Programm = 17 then Form34.Show;
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\pale4l0n.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Palaeostress-manual.htm');
  end;
  HelpRouter1.free;
end;
