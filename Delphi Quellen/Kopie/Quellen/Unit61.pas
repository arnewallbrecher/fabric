...
begin
  ...
  if Gefuegetyp = 1 then ExtensionS := 'TLI';
  if Gefuegetyp = 2 then ExtensionS := 'TPL';
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\stra22gc.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Talbot-manual.htm');
  end;
  HelpRouter1.free;
end;
