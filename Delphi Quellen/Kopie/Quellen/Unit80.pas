...
begin
  ...
  LabelFalscheDaten.Caption := Tx(1257);
  LabelFalscheDaten.Visible := false;
end;
...
begin
  ...
  LabelFalscheDaten.Visible := true;
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\date7fjg.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Map-manual.htm');
  end;
  HelpRouter1.free;
end;
