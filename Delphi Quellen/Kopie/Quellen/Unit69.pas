...
uses
  ...
  Standard, Bmp2Tiff, Plotten, ehsHelpRouter;
...
type
  TForm69 = class(TForm)
    ...
    BMPspeichern: TMenuItem;
    GIFspeichern: TMenuItem;
    TIFspeichern: TMenuItem;
    WMFspeichern: TMenuItem;
    EMFspeichern: TMenuItem;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\talp6rzk.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Talpha-image.htm');
  end;
  HelpRouter1.free;
end;
