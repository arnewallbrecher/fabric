...
begin
  ...
  LabelPitchwinkel.Caption         := Tx(74);
...
begin
  ...
  if EingabeS = 'DisketteA'  then Form5.Show;
  if EingabeS = 'DisketteB'  then Form5.Show;
end;
...
//  SpeedBrunton.Enabled := true;
  if Gedrueckt[1] and Gedrueckt[2] and Gedrueckt[3]
  and Gedrueckt[4]then Buttonweiter.Enabled := true;
  LabelWinkelzwischen.Caption := Tx(824);            {Normale auf 2 Lineare}
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\bere0w2v.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Calculation-main.htm');
  end;
  HelpRouter1.free;
end;
