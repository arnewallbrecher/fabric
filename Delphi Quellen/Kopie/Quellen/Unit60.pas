...
begin
  ...
  if EingabeS =  Laufw2S     then Form62.Show;
end;
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\stra3nzi.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Talbot-main.htm');
  end;
  HelpRouter1.free;
end;
