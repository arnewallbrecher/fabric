...
type
  TForm16 = class(TForm)
    ...
    procedure aufDisketteB1Click(Sender: TObject);
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\zirk9ass.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Circular-Data-manual.htm');
  end;
  HelpRouter1.free;
end;
