...
Interface
uses Kalkulat, Globvar, Basic, Dialogs, SysUtils;
     {Kalkulation, Texte, graph, Plotten; }

procedure Sigrot (Asigma1,Asigma3:word; Fsigma1,Fsigma3:shortint; Zahl:word;
                  Na: array of word; var Narot: array of word;
                  Nf: array of word; var Nfrot: array of shortint;
...
begin
  ...
  Asigma3rot := (540 - Asigma3rot) mod 360;
  for i := 1 to Zahl do
  begin
