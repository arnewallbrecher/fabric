...
procedure TForm74.SpeedBMPoeffnenClick(Sender: TObject);
begin
...
procedure TForm74.SpeedGIFoeffnenClick(Sender: TObject);
begin
...
procedure TForm74.SpeedTIFoeffnenClick(Sender: TObject);
begin
...
procedure TForm74.SpeedJPGoeffnenClick(Sender: TObject);
begin
...
procedure TForm74.SpeedWMFoeffnenClick(Sender: TObject);
begin
...
procedure TForm74.SpeedEMFoeffnenClick(Sender: TObject);
begin
...
procedure TForm74.speichernBMPClick(Sender: TObject);
var
  Rahmen : TRect;
begin
  Bitmap        := TBitmap.Create;
...
procedure TForm74.SpeedBMPClick(Sender: TObject);
begin
  speichernBMPClick(Sender);
end;

procedure TForm74.speichernGIFClick(Sender: TObject);
var
  Bitmap  : TBitmap;
  GifBild : TGifImage;
  Rahmen  : TRect;
...
procedure TForm74.SpeedGIFClick(Sender: TObject);
begin
  speichernGIFClick(Sender);
end;

procedure TForm74.speichernTIFClick(Sender: TObject);
var
  Rahmen : TRect;
begin
  Bitmap        := TBitmap.Create;
...
procedure TForm74.SpeedTIFClick(Sender: TObject);
begin
  speichernTIFClick(Sender);
end;

procedure TForm74.speichernJPGClick(Sender: TObject);
var
  DateiJ   : string;
  Rahmen   : TRect;
  Bild     : TBitmap;
...
procedure TForm74.SpeedJPGClick(Sender: TObject);
begin
  speichernJPGClick(Sender);
end;

procedure TForm74.speichernWMFClick(Sender: TObject);
var
  Metafile   : TMetafile;
...
procedure TForm74.SpeedWMFClick(Sender: TObject);
begin
  speichernWMFClick(Sender);
end;

procedure TForm74.speichernEMFClick(Sender: TObject);
var
  Metafile   : TMetafile;
  MetaCanvas : TMetafileCanvas;
  Bitmap     : TBitmap;
...
procedure TForm74.SpeedEMFClick(Sender: TObject);
begin
  speichernEMFClick(Sender);
end;

procedure TForm74.speichernUBMPClick(Sender: TObject);
begin
...
procedure TForm74.speichernUGIFClick(Sender: TObject);
begin
...
procedure TForm74.speichernUTIFClick(Sender: TObject);
begin
...
procedure TForm74.speichernUJPGClick(Sender: TObject);
begin
  SavePictureDialog1.DefaultExt := GraphicExtension(TJpegImage);
...
procedure TForm74.speichernUWMFClick(Sender: TObject);
begin
...
procedure TForm74.speichernUEMFClick(Sender: TObject);
begin
  SaveDialog1.DefaultExt := GraphicExtension(TMetaFile);
  SaveDialog1.Filter     := GraphicFilter(TMetaFile);
  if SaveDialog1.Execute then
...
begin
  ...
  begin
    ...
    HelpRouter1.HelpJump(DateiS,'html\Deutsch\isog76sr.htm');
  end;
  if SpracheS = 'ENGLISH' then
  begin
    DateiS := DirectS+'\'+'Fabric-Help-Html';
    HelpRouter1.HelpJump(DateiS,'html\English\Isogons-plot.htm');
  end;
  HelpRouter1.free;
end;
